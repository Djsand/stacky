...
The Danish speech adapter also shapes TTS rhythm before synthesis: short markers such as "Okay" and "Fedt" get a sentence pause, and clauses before "men", "hvis", "når", and relevant "så" get clearer pauses. The default Supertonic `quick` profile is tuned for less rushed Danish speech: speed `1.12`, chunk length `160`, silence `0.055`.
